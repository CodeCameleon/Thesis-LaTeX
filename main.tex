...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=\textwidth]{Figures/SymmetricEncryptionRunTime.png} % Kép beszúrása.
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=\textwidth]{Figures/SymmetricDecryptionRunTime.png} % Kép beszúrása.
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=\textwidth]{Figures/SymmetricEncryptionMemoryUsage.png} % Kép beszúrása.
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=\textwidth]{Figures/SymmetricDecryptionMemoryUsage.png} % Kép beszúrása.
