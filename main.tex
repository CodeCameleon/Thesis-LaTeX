...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=\textwidth]{Figures/HashingEncryptionRunTime.png} % Kép beszúrása.
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=\textwidth]{Figures/HashingEncryptionMemoryUsage.png} % Kép beszúrása.
