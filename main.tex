...
A feladat a különböző titkosítási algoritmusok összehasonlítása, különböző szempontok alapján. Továbbá egy saját algoritmus fejlesztése és összehasonlítás a már létező és aktívan használt algoritmusokkal.
...
Az algoritmusom rengeteg változtatáson ment már keresztül. Az elkészült verzió számos irányban továbbfejleszthető. Itt most nem arra gondolok, hogy teljesítményben lemaradottabb a versenytársaival szemben. Hanem a lehetséges fejlesztési irányokra és funkciókra.
...
\section{A tesztelés folyamata} % Sorszámozott alcím létrehozása.
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \fbox{\includegraphics[width=0.98\textwidth]{Figures/TestCases.png}} % Kép beszúrása.
    \caption{A tesztelésre használt tesztesetek} % Az ábra neve.
    \label{fig:TestCases} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/SymmetricEncryptionRunTime.png} % Kép beszúrása.
    \caption{A szimmetrikus algoritmusokkal végzett titkosítás futási idő eredményei} % Az ábra neve.
    \label{fig:SymmetricEncryptionRunTime} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/SymmetricDecryptionRunTime.png} % Kép beszúrása.
    \caption{A szimmetrikus algoritmusokkal végzett visszafejtés futási idő eredményei} % Az ábra neve.
    \label{fig:SymmetricDecryptionRunTime} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/SymmetricEncryptionMemoryUsage.png} % Kép beszúrása.
    \caption{A szimmetrikus algoritmusokkal végzett titkosítás memóriahasználat eredményei} % Az ábra neve.
    \label{fig:SymmetricEncryptionMemoryUsage} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/SymmetricDecryptionMemoryUsage.png} % Kép beszúrása.
    \caption{A szimmetrikus algoritmusokkal végzett visszafejtés memóriahasználat eredményei} % Az ábra neve.
    \label{fig:SymmetricDecryptionMemoryUsage} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/AsymmetricEncryptionRunTime.png} % Kép beszúrása.
    \caption{Az aszimmetrikus algoritmusokkal végzett titkosítás futási idő eredményei} % Az ábra neve.
    \label{fig:AsymmetricEncryptionRunTime} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/AsymmetricDecryptionRunTime.png} % Kép beszúrása.
    \caption{Az aszimmetrikus algoritmusokkal végzett visszafejtés futási idő eredményei} % Az ábra neve.
    \label{fig:AsymmetricDecryptionRunTime} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/AsymmetricEncryptionMemoryUsage.png} % Kép beszúrása.
    \caption{Az aszimmetrikus algoritmusokkal végzett titkosítás memóriahasználat eredményei} % Az ábra neve.
    \label{fig:AsymmetricEncryptionMemoryUsage} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/AsymmetricDecryptionMemoryUsage.png} % Kép beszúrása.
    \caption{Az aszimmetrikus algoritmusokkal végzett visszafejtés memóriahasználat eredményei} % Az ábra neve.
    \label{fig:AsymmetricDecryptionMemoryUsage} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/HashingEncryptionRunTime.png} % Kép beszúrása.
    \caption{A hasító algoritmusokkal végzett titkosítás futási idő eredményei} % Az ábra neve.
    \label{fig:HashingEncryptionRunTime} % Az ábra referenciája.
\end{figure}
...
\begin{figure}[H]
    \centering % Az ábra középre igazítása.
    \includegraphics[width=0.8\textwidth]{Figures/HashingEncryptionMemoryUsage.png} % Kép beszúrása.
    \caption{A hasító algoritmusokkal végzett titkosítás memóriahasználat eredményei} % Az ábra neve.
    \label{fig:HashingEncryptionMemoryUsage} % Az ábra referenciája.
\end{figure}
